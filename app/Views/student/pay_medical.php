...
function payWithPaystack() {
  ...
  var handler = PaystackPop.setup({
    ...
    amount: 3000 * 100, // the amount value is multiplied by 100 to convert to the lowest currency unit
    ...
    callback: function(response) {
	  ...
	  window.location.replace("<?= base_url('payMedical/'.$payment_details->applicant) ?>");
