        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="col-md-8 center-margin">
                        ...
                        <button class="btn btn-primary btn-lg " onclick="payWithPaystack()"> Pay Exam Fee </button>
...
function payWithPaystack() {
  ...
  var handler = PaystackPop.setup({
    ...
    amount: 3700 * 100, // the amount value is multiplied by 100 to convert to the lowest currency unit
    ...
    callback: function(response) {
	  ...
	  window.location.replace("<?= base_url('paymentVerify/'.$payment_details->applicant) ?>");
