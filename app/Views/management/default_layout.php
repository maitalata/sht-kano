...
<html lang="en">
  <head>
    ...
    <title>School of Health Technology, Kano! | Admin Dashboard </title>
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <img src="<?php echo is_file("uploads/staff/passport_".auth()->user()->user_id."_.jpg")?'uploads/staff/passport_'.auth()->user()->user_id.'_.jpg':base_url('images/avatar.png'); ?>" alt="Passport Picture" class="img-circle profile_img" style="width:60px;height:60px;" >
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a><i class="fa fa-users"></i> Student <span class="fa fa-chevron-down"></span></a>
                  ...
                  <?php if (auth()->user()->inGroup('superadmin', 'department')) { ?>
                    <li><a><i class="fa fa-file-text"></i>Courses <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        <li><a href="<?= url_to('allNewStudents') ?>">View All</a></li>
                          <li><a href="<?= url_to('addNewCourse') ?>">Add New Course</a></li>
                      </ul>
                    </li>
                  <?php } ?>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <img src="<?php echo is_file("uploads/students/passport_".auth()->user()->user_id."_.jpg")?'uploads/students/passport_'.auth()->user()->user_id.'_.jpg':base_url('images/avatar.png'); ?>" alt=""> <?= auth()->user()->first_name ?>
                    </a>
   ...
   <script src="../vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <?= $this->renderSection('endOfPageScripts') ?>
