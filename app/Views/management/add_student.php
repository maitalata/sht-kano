...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="images/local_expert.png" type="image/x-icon">
  </head>
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count" style="display:block;width:100%;" >
            ...
            <div class="col-lg-3 col-md-3 col-sm-4  tile_stats_count text-center">
              <img src="images/1.png" style="width:100px;length:100px;" />
            </div>

            <div class="col-lg-3 col-md-3 col-sm-4  tile_stats_count text-center">
                <img src="images/2.png" style="width:100px;length:100px;" />
            </div>
