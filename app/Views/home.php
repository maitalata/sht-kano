...
<html lang="en">
<head>
<title>School of Health Technology Kano</title>
		...
		<nav class="navbar navbar-expand-lg navbar-light py-sm-4 py-2">
			...
			<h1>
				<a class="navbar-brand"  href="index.html"> 
					<img src="images/sht_kano_logo_no_border.jpg" alt="SHT Kano Logo" style="width:60px; height:60px; border-radius:50%;" />
					<b style="color:white;" >SHT Kano</b>
				</a>
			</h1>
			<!-- //logo -->
	...
	<div class="container">
		<div class="banner-text">
			<div class="slider-info mb-4">
				...
				<h3 class="txt-w3_agile mb-3"> Innovative education for a healthier Kano</h3>
				<a href="#" class="mr-2"><i class="fas fa-graduation-cap"></i> Our Courses</a>
				<a href="#"><i class="fas fa-book"></i> Read More</a>
			</div>
			<!-- To bottom button-->
	...
	<div class="container py-sm-3">
		...
		<div class="row welcome-grids">
			<div class="col-lg-4 mb-lg-0 mb-5">
				<h4>Start your health career</h4>
				<p class="mb-3">Join School of Health Technology, Kano to become one the best sought for health practitioners in Kano State.  <br>
                We offer courses that span different health paths
                </p>
				<p> <i class="fas mr-2 fa-hand-point-right"></i> Community Health Courses</p>
				<p> <i class="fas mr-2 fa-hand-point-right"></i> Medical Lab Courses</p>
				<p> <i class="fas mr-2 fa-hand-point-right"></i> Pharmaceutical Technology Courses</p>
				<p> <i class="fas mr-2 fa-hand-point-right"></i> Dental Health Courses</p>
			...
			<div class="col-lg-4 col-sm-6">
				...
				<h4>Start your career</h4>
					<p class="mt-3">Want a career in Health? School of Health Technology, Kano it shall all begin for you.</P>
					<span class="fa fa-cog" aria-hidden="true"></span>
				</div>
				<div class="image1 pt-0">
				<h4>Success for your Future</h4>
					<p class="mt-3">We educate, train and help secure jobs for our teeming students across all programs.</P>
			...
			<div class="col-lg-4 col-sm-6 mt-md-0 mt-4">
				...
				<h4>Great Confidence </h4>
					<p class="mt-3">Boast about your certificate. It's not just any Health Institution, it's School of Health Technology Kano</P>
					<span class="fab fa-accusoft"></span>
				</div>
				<div class="image1 pt-0">
				<h4>Finalize your skill</h4>
					<p class="mt-3">Wanted to augment your studies with special skills? We offer Professional Health Certificates just for you. </P>
		...
		<div class="row bottom-grids">
			<div class="row col-lg-4 mb-lg-0 mb-5">
				...
				<div class="col-lg-9 col-10">
					...
					<p>School of Health Technology Kano pride itself with one of the most experienced teaching among health institutions in Kano State.</p>
				</div>
			</div>
			<div class="row col-lg-4 mb-lg-0 mb-5">
				<div class="col-lg-3 col-2">
				...
				<div class="col-lg-9 col-10">
					...
					<p>Study with in ease and comfort. We have spacious library to accommodate our teeming students.</p>
				</div>
			</div>
			<div class="row col-lg-4">
				...
				<div class="col-lg-9 col-10">
					<h4>Job Placement</h4>
					<p>We help our most bright students get employed by collaborating with Government and other private partners.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row service-grids">
			<div class="col-lg-4 col-md-6">
				<div class="service-grid1">
					...
					<h5>1</h5>
					<h4 class="mb-3">Diploma Courses</h4>
					<p>We offer diploma courses in various health fields ranging from Community Health, Pharmaceutical Technology to Dental Health.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
				<div class="service-grid1">
					...
					<p>We offer 2 years and 1 year certificate courses such as  Junior Community Health Extension Worker (JCHEW) and Certificate in Nutrition</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
				<div class="service-grid1">
					...
					<h5>3</h5>
					<h4 class="mb-3">Professional Certificates</h4>
					<p>We offer short Professional Certificates for registered Health Practitioners to augment their skills</p>
				</div>
			</div>
...
<footer>
		...
		<div class="row footer-gap">
			<div class="col-lg-3 col-sm-6">
				...
				<address class="mb-0">
					...
					<p class="mb-3"><i class="fas fa-map-marker"></i> No. 234 Sani Marshal Road, Kano <br>Nigeria.</p>
					<p><i class="fas fa-clock"></i> Timings : 8 a.m to 6 p.m</p>
					<p><i class="fas fa-phone"></i> +2348000000000</p>
					<p><i class="fas fa-envelope-open"></i> <a href="mailto:info@example.com">info@shtkano.knstate.healthcare</a></p>
				</address>
			</div>
			<div class="col-lg-2 col-sm-6 mt-lg-0 mt-sm-0 mt-4 p-md-0">
				<h3 class="text-uppercase mb-3">School</h3>
				<div class="links">
					<a class="text-capitalize" href="#"> Why Our School</a>
					<a class="pt-2 text-capitalize" href="#"> Student Handbook</a>
					<a class="pt-2 text-capitalize" href="#"> Student App</a>
					<div class="divider"></div>
					<a class="pt-2 text-capitalize" href="#"> Our Department</a>
					<a class="pt-2 text-capitalize" href="#"> Our Courses</a>
	...
	<div class="copyright pb-5 text-center">
		<p>© <?= date('Y') ?>. All Rights Reserved | Developed by <a href="http://www.iworldoftech.com" target="_blank">IWORLDOFTECH</a></p>
	</div>
</footer>
<!-- footer -->
<!-- Login modal -->
